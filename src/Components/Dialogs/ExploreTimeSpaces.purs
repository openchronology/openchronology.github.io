...
import Timeline.UI.ExploreTimeSpaces
  ( WithSpanOfTime (..), ExploreTimeSpaces, ExploreTimeSpacesWithAux (..)
  , toggleOpen, openThrough, exploreTimeSpacesWithAux, updateExploreTimeSpacesWithAux)
...
initialState :: IxSig.IxSignal (read :: S.READ) (WithSpanOfTime ExploreTimeSpaces)
          ...
          pure
            ...
            , render: do
              ...
              pure $ dialog''
                ...
                , dialogContent_
                  [ let printListItem :: Array Index -> SpanOfTime String -> ExploreTimeSpacesWithAux -> Int -> Array ReactElement
                    ...
                    in  case timeSpaces of
                      WithSpanOfTime x -> list {disablePadding: true} $
