...
instance decodeJsonDecidedValue :: DecodeJson DecidedValue where
  decodeJson json = do
    o <- decodeJson json
    let decodeNumber = DecidedValueNumber <$> o .: "numberValue"
    decodeNumber
...
instance decodeJsonDecidedLimit :: DecodeJson DecidedLimit where
  decodeJson json = do
    o <- decodeJson json
    let decodeNumber = DecidedLimitNumber <$> o .: "numberLimit"
    decodeNumber
...
instance decodeJsonDecidedMaybeLimit :: DecodeJson DecidedMaybeLimit where
  decodeJson json = do
    o <- decodeJson json
    let decodeNumber = DecidedMaybeLimitNumber <$> o .: "numberMaybeLimit"
    decodeNumber
...
instance decodeJsonLimit :: DecodeJson a => DecodeJson (Limit a) where
  decodeJson json = do
    o <- decodeJson json
    let limitBounds = LimitBounds <$> o .: "limitBounds"
...
instance decodeJsonMaybeLimit :: DecodeJson a => DecodeJson (MaybeLimit a) where
  decodeJson json = do
    let obj = do
          o <- decodeJson json
          let limitBounds = JustLimitBounds <$> o .: "justLimitBounds"
